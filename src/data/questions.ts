...
export const questionsSinExperiencia: Question[] = [
  { id: 'H01', text: 'Estás en un trabajo y al final del día te das cuenta que tienes C$200 más de lo que deberías tener. ¿Lo reportarías aunque nadie lo note?', stage: 'honesty', reverseScoring: false },
  ...
  { id: 'H04', text: 'En un negocio o restaurante, alguien te paga y sin darse cuenta te da más dinero del que debía. ¿Le devolverías lo que sobra aunque nunca lo descubra?', stage: 'honesty', reverseScoring: false },
  ...
  { id: 'H09', text: 'Alguien de fuera de la empresa te ofrece un regalo personal a cambio de que le hagas un favor que lo beneficia a él pero no a tu empresa. ¿Aceptarías el regalo?', stage: 'honesty', reverseScoring: true },
  { id: 'H10', text: 'Te piden llenar un registro de productos y notas que si cambias un número pequeño nadie lo notaría y quedarías bien con tu jefe. ¿Lo cambiarías?', stage: 'honesty', reverseScoring: true },
  ...
  { id: 'H13', text: 'Te enteras de cosas privadas de tu trabajo, como problemas internos o información que solo el personal debe saber. ¿Se la contarías a alguien de afuera aunque te lo pidan?', stage: 'honesty', reverseScoring: true },
  ...
  { id: 'H15', text: '¿Crees que una persona puede trabajar manejando dinero ajeno y nunca tomar nada que no le pertenece, aunque esté pasando por una situación económica difícil?', stage: 'honesty', reverseScoring: false },
  { id: 'S01', text: 'Si pudieras hacer algo incorrecto y estás 100% seguro de que nadie lo sabría jamás, ¿igual lo evitarías porque así eres tú?', stage: 'sincerity', reverseScoring: false },
  ...
  { id: 'S04', text: 'Si mentir te evitara un problema pero esa mentira perjudicaría a otra persona, ¿lo harías?', stage: 'sincerity', reverseScoring: true },
  ...
  { id: 'S08', text: 'Si necesitas quedar bien ante alguien importante, ¿exagerarías tus cualidades o logros para impresionarlo?', stage: 'sincerity', reverseScoring: true },
  ...
  { id: 'S14', text: 'Si necesitas comprometerte con algo que probablemente no podrás cumplir, ¿lo prometerías igual para salir del momento?', stage: 'sincerity', reverseScoring: true },
  ...
  { id: 'A03', text: 'Si tu jefe te dice que algo que hiciste estuvo mal, ¿lo aceptarías tranquilamente en lugar de ponerte a la defensiva?', stage: 'autocritica', reverseScoring: false },
  ...
  { id: 'A05', text: 'Si estabas seguro de hacer algo bien y un compañero te dice que lo estás haciendo mal, ¿cambiarías tu forma de hacerlo?', stage: 'autocritica', reverseScoring: false },
  ...
  { id: 'A08', text: '¿Crees que a veces actúas sin pensar y luego te arrepientes de lo que hiciste?', stage: 'autocritica', reverseScoring: true },
  ...
  { id: 'A13', text: 'Si todos a tu alrededor hacen algo que va en contra de tus valores, ¿actuarías igual que ellos para no destacar?', stage: 'autocritica', reverseScoring: true },
...
export function getQuestions(modalidad?: string): Question[] {
  return modalidad === 'sin_experiencia' ? questionsSinExperiencia : questionsConExperiencia;
}
