...
export const questionsSinExperiencia: Question[] = [
  ...
  { id: 'H13', text: 'Te enteras de cosas privadas de tu trabajo, como problemas internos o información que solo el personal de la empresa debe saber. ¿Se la contarías a alguien de afuera aunque te lo pidan?', stage: 'honesty', reverseScoring: true },
